defmodule GenexRemoteWeb do
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: GenexRemoteWeb

      import Plug.Conn
      import GenexRemoteWeb.Gettext
  ...
  def view do
    quote do
      use Phoenix.View,
        root: "lib/genex_remote_web/templates",
        namespace: GenexRemoteWeb
